            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table class="data-table table table-bordered table-hover">
                        ...
                        <tr>
                            <td>
                                <a href="{{ route('admin.kantoku.modules.show', [$module->getLowerName()]) }}">
                                    {{ $module->name }}
                                </a>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="{{ route('admin.kantoku.modules.show', [$module->getLowerName()]) }}">
                                    <span class="label label-{{$module->enabled() ? 'success' : 'danger'}}">
                                        {{ $module->enabled() ? trans('kantoku::modules.enabled') : trans('kantoku::modules.disabled') }}
                                    </span>
                                </a>
                            </td>
                        </tr>
