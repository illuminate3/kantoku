...
namespace Modules\Kantoku\Tests;

use Modules\Kantoku\Scaffold\Module\Exception\ModuleExistsException;
...
class ModuleScaffoldTest extends BaseTestCase
{
    ...
    {
        config()->set('asgard.kantoku.config.custom-stubs-folder', __DIR__ . '/stubs');
