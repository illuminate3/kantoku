...
use Modules\Kantoku\Http\Requests\GenerateModuleRequest;
use Modules\Kantoku\Http\Requests\InstallModuleRequest;
use Modules\Kantoku\Http\Requests\MigrateModuleRequest;
use Modules\Kantoku\Http\Requests\SeedModuleRequest;
...
class WorkbenchController extends AdminBaseController
{
    ...
    {
        return View::make('kantoku::admin.workbench.index');
    }
    ...
    public function generate(GenerateModuleRequest $request)
    {
        ...
        return Redirect::route('admin.kantoku.workbench.index');
    }
