...
class ModulesController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        return view('kantoku::admin.modules.index', compact('modules'));
    }
    ...
    public function show(Module $module)
    {
        ...
        return view('kantoku::admin.modules.show', compact('module', 'changelog'));
    }
    ...
    public function disable(Module $module)
    {
        if ($this->isCoreModule($module)) {
            return redirect()->route('admin.kantoku.modules.show', [$module->getLowerName()])
                ->with('error', trans('kantoku::modules.module cannot be disabled'));
        }

        $module->disable();

        return redirect()->route('admin.kantoku.modules.show', [$module->getLowerName()])
            ->with('success', trans('kantoku::modules.module disabled'));
    }
    ...
    public function enable(Module $module)
    {
        ...
        return redirect()->route('admin.kantoku.modules.show', [$module->getLowerName()])->with(
            'success',
            trans('kantoku::modules.module enabled')
        );
    }
